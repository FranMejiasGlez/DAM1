    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <div class="header3">
                    <h2> <xsl:value-of select="//Titulos/Titulo[@Denominacion='Comercio Internacional']"></xsl:value-of></h2> <!--XPATH-->
                </div>
                <div class="header4">
                ...
                <div class="contenedor-competencias ">
                    <div>
                        <div class="rectangulos" style="height: 100px;padding:10px 20px"><xsl:value-of select="//Titulos/Titulo/@Nombre"></xsl:value-of></div> <!--XPATH-->
                    </div>
                    <div>
                        <div class="dropdown">
                            <ul>

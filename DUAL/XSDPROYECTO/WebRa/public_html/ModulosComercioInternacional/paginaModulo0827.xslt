    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <div class="header4">
                    <h2>
                        <xsl:value-of select="//Titulos/Titulo/Modulos/Modulo[@Codigo=0827]/@Nombre"></xsl:value-of>
                    </h2> <!--XPATH-->
                </div>
                ...
                <div class="contenedor-ResultadosAprendizaje">
                    ...
                    <div class="dropdown" style="justify-self:center;">
                        <ul>
                            <xsl:for-each select="//Titulos/Titulo[@Denominacion='Comercio Internacional']/Modulos/Modulo[@Codigo=0827]/ResultadoDeAprendizaje">
                                ...
                                <ul class="dropdown-menu"
                                    ...
                                    <xsl:for-each select="//Titulos/Titulo[@Denominacion='Comercio Internacional']/Modulos/Modulo[@Codigo=0827]/ResultadoDeAprendizaje[@Codigo=concat($idResultado,'')]/CriterioDeEvaluacion">
                                        <p>
                                            <b>Codigo: </b> 

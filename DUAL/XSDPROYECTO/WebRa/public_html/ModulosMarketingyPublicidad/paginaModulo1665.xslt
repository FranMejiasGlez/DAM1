    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <div class="header4">
                    <h2>
                        <xsl:value-of select="//Titulos/Titulo/Modulos/Modulo[@Codigo=1665]/@Nombre"></xsl:value-of>
                    </h2> <!--XPATH-->
                </div>
                ...
                <div class="contenedor-ResultadosAprendizaje">
                    ...
                    <div class="dropdown" style="justify-self:center;">
                        <ul>
                            <xsl:for-each select="//Titulos/Titulo[@Denominacion='Marketing y Publicidad']/Modulos/Modulo[@Codigo=1665]/ResultadoDeAprendizaje">
                                ...
                                <ul class="dropdown-menu"
                                    ...
                                    <xsl:for-each select="//Titulos/Titulo[@Denominacion='Marketing y Publicidad']/Modulos/Modulo[@Codigo=1665]/ResultadoDeAprendizaje[@Codigo=concat($idResultado,'')]/CriterioDeEvaluacion">
                                        <p>
                                            <b>Codigo: </b> 

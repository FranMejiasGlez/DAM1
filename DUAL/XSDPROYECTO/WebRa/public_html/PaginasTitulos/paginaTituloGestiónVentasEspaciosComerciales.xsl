                    ...
                    <div class="item2">
                        <div class="dropdown" style="margin-right: 40%;">
                            ...
                            <ul class="dropdown-menu"
                                ...
                                <xsl:for-each select="//Titulos/Titulo[@Denominacion='Gestión de Ventas y Espacios Comerciales']/CompetenciaProfesionalPersonalySocial">
                                    <p>
                                        <b>Codigo: </b> 
                ...
                <div class="contenedor-objetivos ">
                    ...
                    <div class="item4">
                        <div class="dropdown" style="margin-right: 40%;">
                            ...
                            <ul class="dropdown-menu"
                                style="text-align:justify;text-align: center;max-height: 500px;  overflow-y: auto;">
                                <xsl:for-each select="//Titulos/Titulo[@Denominacion='Gestión de Ventas y Espacios Comerciales']/ObjetivoGeneral">
                                    <p>
                                        <b>Codigo: </b> 
                                        <xsl:value-of select="@Codigo"></xsl:value-of> 
                                        <br></br>
                    ...
                    <div class="item7">
                        <div class="dropdown" style="margin-right: 40%;">
                            ...
                            <ul class="dropdown-menu" style="margin-right: 40%;">
                                <xsl:for-each select="//Titulos/Titulo[@Denominacion='Gestión de Ventas y Espacios Comerciales']/Modulos/Modulo[@Curso=1]">
                                    <xsl:variable name="CodModulo" select="@Codigo"/>
                                    <li>
                                        <a style="text-decoration: none;" href="../ModulosGestiónVentasEspaciosComerciales/paginaModulo{$CodModulo}.xslt"> 
                ...
                <div class="contenedor-modulos2">
                    ...
                    <div class="item9">
                        <div class="dropdown" style="margin-right: 40%;"> 
                            ...
                            <ul class="dropdown-menu" style="margin-right: 40%;">
                                  <xsl:for-each select="//Titulos/Titulo[@Denominacion='Gestión de Ventas y Espacios Comerciales']/Modulos/Modulo[@Curso=2]">
                                    <xsl:variable name="CodModulo" select="@Codigo"/>
                                    <li>
                                        <a style="text-decoration: none;" href="../ModulosGestiónVentasEspaciosComerciales/paginaModulo{$CodModulo}.xslt"> 
                                            <xsl:value-of select="@Nombre"></xsl:value-of>

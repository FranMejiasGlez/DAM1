    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <div class="header3">
                    <h2>
                        <xsl:value-of select="//Titulos/Titulo[1]/@Nombre"></xsl:value-of>
                    </h2>
                            ...
                            <div class="accordion rounded-5" id="competenciaspps"
                                ...
                                <div class="accordion-item rounded-5 mb-2">
                                    ...
                                    <div id="collapseTwo"
                                        ...
                                        <div class="accordion-body"  >
                                            <xsl:for-each select="//Titulo[1]/CompetenciaProfesionalPersonalySocial ">
                                                <p>
                            ...
                            <div class="accordion rounded-5" id="objetivosgenerales"
                                ...
                                <div class="accordion-item rounded-5 mb-2">
                                    ...
                                    <div id="collapseThree"
                                        ...
                                        <div class="accordion-body">
                                            <xsl:for-each select="//Titulos/Titulo[1]/ObjetivoGeneral">
                                                <p>
                                                    <b>Codigo: </b> 
                ...
                <div class="contenedor-modulos1">
                    ...
                    <ul style="margin-left:12%;">
                        <xsl:for-each select="//Titulos/Titulo[1]/Modulos/Modulo[@Curso='1']">
                                            ...
                                            <div id="collapse{$idAccordion}"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <li style="list-style:none;text-decoration:none;">
                                                        ...
                                                        <a style="text-decoration: none;" href="../ModulosMarketingyPublicidad/Modulo{$CodModulo}.html"> 
                                                            Mas informacion
                                                        </a>
                                                    </li>
                ...
                <div class="contenedor-modulos2">
                    ...
                    <ul style="margin-left:12%;">
                        <xsl:for-each select="//Titulos/Titulo[1]/Modulos/Modulo[@Curso='2']">

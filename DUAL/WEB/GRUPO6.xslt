    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <div class="header3">
                    <h2> <xsl:value-of select="//Titulos/Titulo/@Nombre"></xsl:value-of></h2> <!--XPATH-->
                </div>
                <div class="header4">
                    <h2><xsl:value-of select="//Titulos/Titulo/Modulos/Modulo/@Nombre"></xsl:value-of></h2> <!--XPATH-->
                </div>
                <xsl:choose>
                    <xsl:when test="//Titulos/Titulo[@Denominacion='Comercio Internacional']">
                        <div class="contenedor-competencias ">
                            <div>
                                <div class="rectangulos" style="height:100px;text-align: center;padding:15px 20px">
                                    <xsl:value-of select="//Titulos/Titulo/@Nombre"></xsl:value-of>
                                </div> <!--XPATH-->
                            </div>
                            <div>
                                <div class="dropdown">
                        ...
                        <div class="contenedor-ResultadosAprendizaje">
                            ...
                            <div class="dropdown" style="justify-self:center;">
                                <ul>
                                    <xsl:for-each select="//Titulos/Titulo[@Denominacion='Comercio Internacional']/Modulos/Modulo[@Codigo=0623]/ResultadoDeAprendizaje">
                                        ...
                                        <ul class="dropdown-menu"
                                            ...
                                            <xsl:for-each select="//Titulos/Titulo[@Denominacion='Comercio Internacional']/Modulos/Modulo[@Codigo=0623]/ResultadoDeAprendizaje[@Codigo=concat($idResultado,'')]/CriterioDeEvaluacion">
                                                <p>
                                                    <b>Codigo: </b> 
                    ...
                    </xsl:when><!-- Titulo es Comercio Internacional-->
                    <xsl:when test="//Titulos/Titulo[@Denominacion='Marketing y Publicidad']">
                        <div class="contenedor-competencias ">
                            <div>
                        ...
                        <div class="contenedor-ResultadosAprendizaje">
                            ...
                            <div class="dropdown" style="justify-self:center;">
                                <ul>
                                    <xsl:for-each select="//Titulos/Titulo[@Denominacion='Marketing y Publicidad']/Modulos/Modulo[@Codigo=0623]/ResultadoDeAprendizaje">
                                        <xsl:variable name="idResultado" select="@Codigo"/>
                                        <br></br>
                                        <button type="button"
                                                style="text-align: center;padding:30px 30px;white-space: normal;width: 100%; max-width: 500px; height:auto;font-size: 18px; font-weight: bold; color: white; border-radius: 999px;"
                    ...
                    </xsl:when><!-- Titulo es Marketing y Publicidad-->
                    <xsl:when test="//Titulos/Titulo[@Denominacion='Gestión de Ventas y Espacios Comerciales']">
                        <div class="contenedor-competencias ">
                            <div>
                                <div class="rectangulos">Buscar Curso xpath</div> <!--XPATH-->
                            </div>
                        ...
                        <div class="contenedor-ResultadosAprendizaje">
                            ...
                            <div class="dropdown" style="justify-self:center;">
                                <ul>
                                    <xsl:for-each select="//Titulos/Titulo[@Denominacion='Gestión de Ventas y Espacios Comerciales']/Modulos/Modulo[@Codigo=0623]/ResultadoDeAprendizaje">
                                        <xsl:variable name="idResultado" select="@Codigo"/>
                                        <br></br>
                                        <button type="button"
                                                style="text-align: center;padding:30px 30px;white-space: normal;width: 100%; max-width: 500px; height:auto;font-size: 18px; font-weight: bold; color: white; border-radius: 999px;"
                    ...
                    </xsl:when><!-- Titulo es Gestion de Ventas y Espacios Comerciales-->
                </xsl:choose>
                <div class="contenedor-competencias ">
                    <div>
                        <div class="rectangulos">Buscar Curso xpath</div> <!--XPATH-->
